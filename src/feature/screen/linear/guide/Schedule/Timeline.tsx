...
import { openingMillisState, timeBarVisibleWidthState } from '@/atom/screen/linear';
...
// const TIME_BAR_BASE_WIDTH = 1654;
...
export function Timeline() {
    ...
    const { times, currentSlotMillis, timeBarOffset } = useTimeline(openingMillis);
...
const TimeSlot = styled.span<{ offset: number }>`
    ...
    transform: translateX(${({ offset }) => `-${timeSlotStyle.box() * offset}rem`});
